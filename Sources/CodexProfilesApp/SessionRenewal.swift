...
enum SessionRenewal {
    ...
    private static func request(executable: URL, home: URL, timeout: TimeInterval = 30,
        ...
        do {
            try send(["id": 0, "method": "initialize", "params": ["clientInfo": ["name": "codex_profiles", "title": "Codex Profiles", "version": "1.10"], "capabilities": ["experimentalApi": experimental]]], to: input)
            var pending = Data()
            var totalBytes = 0
